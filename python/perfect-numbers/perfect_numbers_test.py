...
from perfect_numbers import classify, split_in_proper_dividers
...
class DecomposeInProperDividersTest(unittest.TestCase):
    def test_should_return_every_dividers(self):
        self.assertListEqual(split_in_proper_dividers(15), [1, 3, 5])
        self.assertListEqual(split_in_proper_dividers(28), [1, 2, 4, 7, 14])
